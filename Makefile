...
.PHONY: list add analyze article check commit diff edit implement install languages memo onboard open project refactor reload run status trail undo upgrades deps
