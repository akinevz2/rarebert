...
.PHONY: list add analyze article backend check commit diff edit implement install languages memo open project refactor reload run status trail undo deps
