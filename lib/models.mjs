...
const readOpendeConfig = () => models.readConfig();
const listModels = (config) => models.list(config);
const promptModel = (m, fallback) => models.prompt(m, fallback);
const resolveModel = (arg, env) => models.resolve(arg, env);

export { Models, models, DEFAULT_MODEL, readOpendeConfig, listModels, promptModel, resolveModel };
export default {
    Models,
    models,
    DEFAULT_MODEL,
