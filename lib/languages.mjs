...
const listLanguages = () => languages.list();
const supportedExtensions = () => languages.supportedExtensions();
const extensionToLanguage = (ext) => languages.extensionToLanguage(ext);
const isSupported = (ext) => languages.isSupported(ext);
const templatePathFor = (ext) => languages.templatePathFor(ext);
const installLanguage = (lang, opts) => languages.install(lang, opts);
