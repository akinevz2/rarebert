...
class AbstractLspAdapter {
    ...
    async start(ctx) { throw new AbstractMethodError('AbstractLspAdapter.start'); }
    async documentSymbols(absPath) { throw new AbstractMethodError('AbstractLspAdapter.documentSymbols'); }
    async definitions(absPath, position) { throw new AbstractMethodError('AbstractLspAdapter.definitions'); }
    async references(absPath, position) { throw new AbstractMethodError('AbstractLspAdapter.references'); }
    async shutdown() { throw new AbstractMethodError('AbstractLspAdapter.shutdown'); }
}
