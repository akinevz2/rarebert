...
const BINARY_PATH = path.join(home.root, BINARY_REL);
...
class Opencode {
    ...
    resolve() {
        ...
        return exit('opencode: no working binary found after install attempt');
    }
}

const opencode = new Opencode();
export { Opencode, opencode, BINARY_PATH };
