...
class Libs {
    ...
    async generateBoilerplate(directory, moduleName, ext = '.mjs', libDir = this.libDir) {
    ...
    async createModule(directory, moduleName, ext = '.mjs') {
        ...
        fs.writeFileSync(modulePath, await this.generateBoilerplate(directory, moduleName, ext));
        return modulePath;
    }
